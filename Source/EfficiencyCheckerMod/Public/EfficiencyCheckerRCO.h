...
public:
	...
	UFUNCTION(BlueprintCallable, Server, WithValidation, Reliable, Category="EfficiencyCheckerRCO", DisplayName="SetMachineStatusIncludeType")
	virtual void SetMachineStatusIncludeTypeRPC
	(
		class AEfficiencyCheckerBuilding* efficiencyChecker,
